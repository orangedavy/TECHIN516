...
control_points = ax.scatter([0.576, 0.351, -0.113, -0.001], [0.002, 0.461, 0.245, -0.025], [0.434, 0.862, 1.220, 1.307], color='orange')
waypoints = ax.scatter(data[0], data[1], data[2])
