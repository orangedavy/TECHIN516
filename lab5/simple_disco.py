...
#    move_group = MoveGroupInterface("arm_with_torso", "base_link")
    ...
    disco_poses = [[0, 1.5, 1.05, 1.43, -1.29, -0.72, -1.61, -0.09],
                   [0, 0.65, -0.77, 2.15, -1.17, 0.73, -1.4, -0.77],
                   [0, 0.4, 0.38, 2.72, -1.27, 2.13, -0.45, -2.08],
                   [0, 0.56, 0.09, 1.64, -2.25, 1.34, -1.41, -2.3],
                   [0, 1.13, 1.47, 2.41, -1.87, -0.19, -1.31, 0.23]]
    ...
    for pose in disco_poses:
        ...
        if result:
            ...
            if result.error_code.val == MoveItErrorCodes.SUCCESS:
                ...
                rospy.logerr(result.error_code.val)
